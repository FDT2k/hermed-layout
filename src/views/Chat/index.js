...
export default props => {
  const {autoscroll, dragAndDrop,handleChange,handleSubmit} = props;
  ...
  return (
    <div className="hermed-chat">
      ...
      <ChatFooter inputHandleSubmit={_handleSubmit} inputHandleChange={_handleChange} inputValue={inputValue}/>
